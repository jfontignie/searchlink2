...
import org.searchlink.controller.ProductController;
...
privileged aspect ProductController_Roo_Controller {
    ...
    @Autowired
    AuthorService ProductController.authorService;
    ...
    void ProductController.populateEditForm(Model uiModel, Product product) {
        ...
        uiModel.addAttribute("productstates", Arrays.asList(ProductState.values()));
    }
